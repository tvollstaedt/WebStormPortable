...
user in an INI file next to PhpStormPortable.exe called PhpStormPortable.ini.
...
copy AppNamePortable.ini from this directory to PhpStormPortable.ini next to
PhpStormPortable.exe. The options in the INI file are as follows:
